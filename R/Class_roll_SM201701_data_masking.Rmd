---
title: "SM201701 Class Roll Personal Info Masked"
author: "coop711"
date: "`r Sys.Date()`"
...
```{r, data}
class_roll <- read.xlsx("../data/class_roll.xlsx", 1, startRow = 2, endRow = 32, colIndex = c(3:7, 9), colClasses = rep("character", 6), encoding = "UTF-8", stringsAsFactors = FALSE)
...
write.csv(class_roll, file ="../data/class_roll_masked.csv", row.names = FALSE)
