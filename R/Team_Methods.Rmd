---
title: "Team Allocation (Randomization) : SM201701"
author: "coop711"
date: "`r Sys.Date()`"
...
class_roll <- read.csv("../data/class_roll_masked.csv", colClasses = rep("character", 6), stringsAsFactors = FALSE)
str(class_roll)
```
...
<!--
```{r, save}
save.image("./team_1701_out.RData")
```
-->